...
static int nl_send(int fd, int type, const void *body, size_t body_len, uint32_t seq) {
...
static int add_iface(struct real_state *rs, struct ifinfomsg *ifi, struct rtattr **tb) {
...
static int add_vxlan(struct real_state *rs, struct ifinfomsg *ifi, struct rtattr **tb) {
...
static int add_vlan(struct real_state *rs, struct ifinfomsg *ifi, struct rtattr **tb) {
